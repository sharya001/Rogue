...
```
MODULE 1: 核心配置与状态 (01-config.js, ~567行)
...
MODULE 3: 地图系统 (03-map.js, ~1069行)
  - 城堡大厅 / 地城生成 / 特殊房间 / 铁匠铺 / 渲染 / 缩放

MODULE 4a: 移动与状态 (04a-move.js, ~355行)
  - updateStatusBar / updateFloorInfo / movePlayer

MODULE 4b: 战斗与升级 (04b-fight.js, ~1261行)
  - combat(Boss+普通) / afterKillEffects / 战斗特效(5种) / Dot / 升级

MODULE 5: 装备与商店 (05-equipment.js, ~522行)
  - 装备生成/比较/宝箱/商店/事件NPC/enterDungeon

MODULE 6: 天赋系统 (06-talents.js, ~211行)
  - 18天赋 + Q键主动技能 + tickSkillTurns

MODULE 7: UI核心 (07-ui.js, ~632行)
  - 游戏结束/重新开始/角色面板/装备详情/升级弹窗

MODULE 7b: 排行榜 (07b-leaderboard.js, ~76行)
  - calcScore / loadLeaderboard / saveToLeaderboard / showLeaderboard

MODULE 7c: 存档系统 (07c-save.js, ~147行)
  - autosaveGame / hasSaveData / continueGame / deleteSave

MODULE 7d: 工匠工坊 (07d-workshop.js, ~39行)
  - showWorkshop / closeWorkshop / buyUpgrade

MODULE 7e: 特效辅助 (07e-effects.js, ~154行)
  - drawCastleBg / refreshStartScreen / showEventEffect / showKeyHelp

MODULE 8: 初始化 (08-init.js, ~350行)
  - 开场动画/职业选择/头像/随机名/成就系统

MODULE 8b: 键盘控制 (08b-keyboard.js, ~220行)
  - keydown handler / 调试键 / 移动/技能键

MODULE 9: 元升级/诅咒/传奇 (09-meta.js, ~200行)
  - 工匠永久升级数据+存取+购买+重置
...
1. **备份当前版本** — 大改动（≥50行或涉及新系统）前先备份：
   - 游戏文件 + 3份文档（README/CHANGELOG/DEVELOPMENT）→ `backups/`
...
4. **更新 4 份文档**:
   ...
   - GUIDE.md: 版本号 + 玩家指南同步（新功能/新机制/FAQ）
